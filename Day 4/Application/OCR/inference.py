...
nn.setBlobPath(str((Path(__file__).parent / Path('PathToTextDetectionBlob')).resolve().absolute()))
...
nn2.setBlobPath(str((Path(__file__).parent / Path('PathToTextPredictionBlob')).resolve().absolute()))
